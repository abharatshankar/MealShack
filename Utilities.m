...
+(void)savePassword:(NSString *)type{
    [USERDEFAULTS setObject:type forKey:@"savePassword"];
    [USERDEFAULTS synchronize];
}

+(NSString *)getPassword{
    return [USERDEFAULTS objectForKey:@"savePassword"];
}
...
+(void)savechangedPhoneno:(NSString *)type{
    [USERDEFAULTS setObject:type forKey:@"savechangedPhoneno"];
    [USERDEFAULTS synchronize];
}

+(NSString *)getchangedPhoneno{
    return [USERDEFAULTS objectForKey:@"savechangedPhoneno"];
}
...
+ (void)setUserMobile:(NSString *)userMobile{
    ...
    [NSUserDefaults.standardUserDefaults setValue:userMobile forKey:@"USER_MOBILE"];
    [NSUserDefaults.standardUserDefaults synchronize];
...
+ (NSString*)getUserMobile{
    ...
    NSString *usermobile = [NSUserDefaults.standardUserDefaults valueForKey:@"USER_MOBILE"];
