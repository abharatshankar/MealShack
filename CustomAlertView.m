...
//  Copyright © 2016 Possibillion. All rights reserved.
//
...
//    self.backgroundColor = [UIColor colorWithRed:107.0/255.0 green:201.0/255.0 blue:200.0/255.0 alpha:1];
    ...
    messageLabel.font = [UIFont fontWithName:@"MyriadPro-Regular" size:17];
...
//    [secondButton setTitleColor:[UIColor colorWithRed:107.0/255.0 green:200.0/255.0 blue:200.0/255.0 alpha:1] forState:UIControlStateNormal];
    ...
    [firstButton setTitleColor:WHITECOLOR forState:UIControlStateNormal];
        [secondButton setTitleColor:WHITECOLOR forState:UIControlStateNormal];
    
    
    [firstButton setBackgroundColor:REDCOLOR];
    [secondButton setBackgroundColor:REDCOLOR];
...
-(float)labelHeight:(NSString*)text :(CGFloat)labelwidth andFont:(float)fontSize
{
    ...
    if(text != nil){
        ...
        attributedText = [[NSAttributedString alloc] initWithString:text attributes:@{NSFontAttributeName:[UIFont fontWithName:PROXIMANOVAREGULAR size:fontSize]}];
